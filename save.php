...
<body>
    <?Php
        ...
        $query = "INSERT INTO usuarios (cedula, nombre, apellido, telefono, email, clave, admin ) VALUES ('$cedula', '$nombre', '$apellido', '$telefono', '$email', '$clave', '$admin')";
        ...
        if (mysqli_query($con, $query)) {
            ...
            $msj = "Registro no se pudo Guardar";
